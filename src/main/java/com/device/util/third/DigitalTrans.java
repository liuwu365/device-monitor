...
public class DigitalTrans {
    ...
    private static String getDecimal(String str) {
        //十六进制-->二进制
        String two = hexStringToBinary(str);
        //去掉一个首位
        two = two.substring(1);
        //拼接二进制 每隔8位添加一个空格
        ...
        for (int i = 0; i < split.length; i++) {
            long btd = binaryToAlgorism(split[i].toString());
            result.append(btd + " ");
        }
    ...
    public static void main(String[] args) {
        ...
        //String str = "8f0549";
        //String two = hexStringToBinary(str);
        //System.out.println("16进制-->二进制:" + two);
        //去掉一个首位后,每隔8位一个空格,再二进制-->十进制
        //two = two.substring(1);
        //System.out.println("0001111 00000101 01001001");
        //System.out.println("二进制-->十进制:" + Integer.parseInt(two, 2));

        //System.out.println(getDecimal(two));

        //System.out.println(getDecimal("8f0549"));

        //System.out.println(binaryToAlgorism("00011110"));

        //二进制-->十进制
        System.out.println(Integer.valueOf("0001111",2).toString() );
    }
